			...
			for (i=1; i<=10; i++){
				...
				if (isNaN(sValorCapturado))
					...
					if (nCapturado == (nTabla*i)){
						nCalif++;
						document.getElementById("txtResultado"+i).style.backgroundColor = "#8cff6d"; //color verde
					}else{
						document.getElementById("txtResultado"+i).style.backgroundColor = "#ff6060"; //color rojo
					}
				}
			}
		}
